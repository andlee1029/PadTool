...
# print("hellow")
# monsters = monster.load_monster_data()
# for mon in monsters:
#     # if mon.id == 7173:
#     print(mon)
monster = [1,"Tyrra",0,-1,0,4,-1,2,2,1,5,400,100,700,52,144,1,57,71,1,8,13,1,1500000,2.5,1,51,1,320,9600,1,51,1530,1,8,80,1,10,32,15,1929,152,0,0,0,0,155,156,157,158,159,0,0,0,0,0,0,0,2,21,21,"",1929,2,-1,1,0,0,2,"",0,0,0,"",1049088,0,0,0,-1,0]
